<template>
    <footer>
        <div class="footer-content">
            <section class="global-nav-section">
                ...
                <div class="external-pages">
                    <nav>
                        <ul>
                            <li><strong>¿Buscas algo más?</strong></li>
                            <ul>
                                <li>Próximamente...</li>
                            </ul>
                        </ul>
            ...
            <section class="connect-section">
                ...
                <div class="connect">
                    <a style="color: blueviolet;" href="https://github.com/GabFrogGo" referrerpolicy="no-referrer" rel="author" target="_blank">
